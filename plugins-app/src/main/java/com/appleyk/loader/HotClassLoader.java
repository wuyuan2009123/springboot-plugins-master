...
public class HotClassLoader extends URLClassLoader {
    ...
    /**设定插件默认放置的路径*/
    public static String PLUGINS_DIR = "classpath:plugins";
    ...
    public static void loadAllJar() throws Exception{
        System.out.println("000:"+ResourceUtils.getFile(PLUGINS_DIR).getPath());
        File file = null;
        file = checkPluginDir();
        /** 如果存在，遍历目录下面的所有子文件对象*/
    ...
    private static File checkPluginDir() {
        ...
        try{
            ...
            System.out.println("PLUGINS_DIR classesPath :"+PLUGINS_DIR);
